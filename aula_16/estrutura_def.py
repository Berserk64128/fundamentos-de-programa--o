...
# Calcule o preço total de uma pizza onde será passado um dicionário com os tamanhos e valores. Além disso, o cliente pode solicitar ou não a borda recheada. Ao finak, retorne o preço.
# 1.Pequeno, Média ou Grande. Qualquer pizza terá o mesmo valor dependendo do tamanho.
